                    ...
                    <tbody>
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge badge-{{ $order->status === 'Draft' ? 'warning' : ($order->status === 'In Progress' ? 'info' : 'success') }}">
                                        {{ $order->status }}
                                    </span>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        @if ($order->status === 'Draft')
                                            <button class="btn btn-sm btn-info check-stock"
                                                data-id="{{ $order->id }}">Cek Stock</button>
                                        @endif

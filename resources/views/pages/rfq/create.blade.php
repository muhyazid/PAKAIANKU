                ...
                <div class="table-responsive">
                    <table class="table table-dark" id="materials-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <!-- Dropdown untuk memilih material, harga diambil dari atribut data-price -->
                                    <select name="materials[0][material_id]" class="form-control material-select" required>
                                        <option value="">Pilih Material</option>
                                        @foreach ($materials as $material)
                                            <option value="{{ $material->id }}" data-price="{{ $material->price }}">
                                ...
                                <td>
                                    <!-- Input harga material yang akan diisi otomatis -->
                                    <input type="text" name="materials[0][material_price]"
                                        class="form-control price-input" value="0" readonly>
                                </td>
                                <td>
                                    <!-- Input subtotal untuk setiap baris material -->
                                    <input type="text" name="materials[0][subtotal]" class="form-control subtotal-input"
                                        value="0" readonly>
                                </td>
                                <td>
                                    <!-- Tombol untuk menambah baris material -->
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Event listener untuk dropdown material
                materialsTable.addEventListener('change', function(event) {
                    if (event.target.classList.contains('material-select')) {
                        // Ambil harga dari atribut data-price pada material yang dipilih
                        ...
                        priceInput.value = price || 0; // Set harga ke input harga
                        calculateSubtotal(row); // Hitung subtotal untuk baris

                        // Jika jumlah sudah diisi, update subtotal
                        if (quantityInput.value) {
                            calculateSubtotal(row);
                        }
                    }
